...
public class ShowBienAgence extends JPanel {
	...
	public ShowBienAgence(Bien bien) {
		...
		panelShowBienAgence.setBounds(0, 0, 1366, 492);
		...
		LabelLocalisationE.setIcon(new ImageIcon(ShowBien.class.getResource("/ressource/rsz_map-location-location-icon.jpg")));
