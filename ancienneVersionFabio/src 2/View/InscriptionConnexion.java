...
public class InscriptionConnexion extends JPanel {
	...
	public InscriptionConnexion() {
		...
		panelInscription.setBounds(662, 44, 571, 521);
		...
		EmailInsLabel.setBounds(16, 208, 130, 29);
		...
		emailInscri.setBounds(227, 211, 214, 23);
		...
		PasswordInscriLabel.setBounds(28, 271, 117, 23);
		...
		passwordInscri.setBounds(227, 271, 214, 23);
		...
		telephoneLabel.setBounds(39, 320, 107, 35);
		...
		telephone.setBounds(227, 326, 214, 23);
		...
		adresseLabel.setBounds(53, 375, 107, 35);
		...
		submit_connexion.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				Client client = cd.isExistClient(email.getText());
				
				EmployeDao ed = new EmployeDao();
				Employe employe = ed.isExistEmploye(email.getText());
				
				ProprietaireDao pd = new ProprietaireDao();
				Proprietaire proprietaire = pd.isExistProprio(email.getText());
				
				if (user != null) {
					InscriptionConnexion.currentUser = user;
					JOptionPane.showMessageDialog(null,"BRAVO  "+ currentUser.getPrenom()+" , vous êtes bien connecté",
							"Connexion",JOptionPane.INFORMATION_MESSAGE);
					if (client != null) {
						panelInscriptionConnexion.removeAll();
						EspaceClient ec = new EspaceClient();
						panelInscriptionConnexion.add(ec);
						...
						panelInscriptionConnexion.add(ee);
						panelInscriptionConnexion.repaint();
						panelInscriptionConnexion.revalidate();
					}
						...
						panelInscriptionConnexion.add(ep);
						panelInscriptionConnexion.repaint();
						panelInscriptionConnexion.revalidate();
					}
					else {
						...
						panelInscriptionConnexion.add(ea);
						panelInscriptionConnexion.repaint();
						panelInscriptionConnexion.revalidate();
					}
				}
		...
		matriculeLabel.setBounds(28, 50, 117, 38);
		...
		employe_select.addMouseListener(new MouseAdapter() {
			public void mouseClicked(MouseEvent e) {
				...
				//Valeurs par defaut pour les employes
				telephone.setText("0601751123");
				adresse.setText("11 Rue Suzane Oliveira");
			}
		});
		...
		submit_inscri.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (prenom.getText().length() == 0 
						...
						|| String.valueOf(passwordInscri.getPassword()).length() == 0  
						|| adresse.getText().length() == 0 
						|| telephone.getText().length() == 0 
						|| emailInscri.getText().length() ==0)  {
		...
		submit_inscri.setBounds(227, 444, 214, 35);
