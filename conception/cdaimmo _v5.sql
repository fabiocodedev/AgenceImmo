...
ALTER TABLE `bien`
  ADD PRIMARY KEY (`id`),
  ADD KEY `Bien_Employe_FK` (`employe`),
  ADD KEY `Bien_Achat_FK` (`achat`),
  ADD KEY `Bien_Location_FK` (`location`),
...
--
ALTER TABLE `bien`
  ADD CONSTRAINT `Bien_Achat_FK` FOREIGN KEY (`achat`) REFERENCES `achat` (`id`),
  ADD CONSTRAINT `Bien_Employe_FK` FOREIGN KEY (`employe`) REFERENCES `employe` (`id`),
  ADD CONSTRAINT `Bien_Location_FK` FOREIGN KEY (`location`) REFERENCES `location` (`id`),
