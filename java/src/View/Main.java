...
public class Main extends JFrame {
	...
	public Main() {
		...
		btnHome.setIcon(new ImageIcon(Main.class.getResource("/ressource/rsz_home.png")));
		...
		NewAccueil an = new NewAccueil();
		an.setBounds(0, -174, 1372, 81);
		panelFooter.add(an);
		...
		labelCopyright.setIcon(new ImageIcon(Main.class.getResource("/ressource/rsz_copyright.png")));
